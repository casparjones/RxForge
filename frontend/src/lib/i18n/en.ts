export const en = {
  ...
  syncLog: {
    title: 'Sync history',
    open: 'History',
    subtitle: 'Which device wrote or deleted which document.',
    devices: 'Devices',
    events: '{n} entries',
    noEvents: 'No sync operations logged yet.',
    noEventsHint: 'The trail fills up as soon as a client pushes with a device id.',
    noResults: 'No entries for this filter.',
    ...
    massDeleteWarning: 'This device caused an unusual number of deletions.',
    docFilterHint: 'Filtered by document: {id}',
  },
